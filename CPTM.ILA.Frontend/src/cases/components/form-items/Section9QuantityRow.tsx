...
const Section9QuantityRow = (props: {
    ...
    useEffect(() => {
        if (props.isEditing) {
            ...
            for (const categoria of Object.values(
                watch("categoriaDadosPessoais")
            )) {
            ...
            for (const item of Object.values(
                watch("catDadosPessoaisSensiveis")
            )) {
                if (Array.isArray(item)) {
        ...
        <React.Fragment>
            <Row className="mb-3">
                ...
                <OverlayTrigger
                    ...
                    overlay={
                        <Tooltip className="text-muted">
                            Informar a quantidade total de dados pessoais e
                            dados pessoais sensíveis descritos no invetário.
                            <br />
                            <b>Exemplo:</b>
                            <br />
                            Tratamento de dados pessoais de detalhes pessoais
                            como Idade, sexo, data de nascimento, local de
                            nascimento, estado civil, nacionalidade.
                            <br />
                ...
                <Col lg={1}>
                    <Row>
                        <CreateCommentBox
                            item={CaseIndexDictionary.qtdeDadosTratados}
                        />
                    </Row>
                </Col>
            </Row>
            <Row className="mb-3">
                <Col lg={1}>
                    <p>
                        {CaseIndexDictionary.qtdeDadosSensiveisTratados.number}
                    </p>
                </Col>
                <OverlayTrigger
                    placement="right"
                ...
                <Col lg={1}>
                    <Row>
                        <CreateCommentBox
                            item={
                                CaseIndexDictionary.qtdeDadosSensiveisTratados
                            }
                        />
                    </Row>
                </Col>
