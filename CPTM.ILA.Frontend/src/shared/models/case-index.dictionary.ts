export const CaseIndexDictionary = {
    ...
    operador: { number: "2.2", title: "Operador" },
    encarregado: { number: "2.3", title: "Encarregado" },
    extensaoEncarregado: { number: "2.4", title: "Extensão Encarregado" },
    areaTratamentoDados: { number: "2.5", title: "Área Tratamento Dados" },
