                        ...
                        {!isComiteReq && !props.approve && (
                            <Row className="mb-3">
                                ...
                                >
                                    ...
                                    <Form.Control.Feedback type="invalid">
                                        {
                                            methods.formState.errors.emailFile
                                                ?.message
                                        }
                                    </Form.Control.Feedback>
                                </Form.Group>
                            ...
                            <React.Fragment>
                                <ButtonGroup className="float-end mt-3">
                                    <Button
                                        variant="danger"
                                        onClick={() =>
                                            props.onReject!(methods.getValues())
                                        }
                                    >
                                        Reprovar
                                    </Button>
